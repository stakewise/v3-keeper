...
class TestRewardsCache:
    async def test_rewards_cache(self):
        ...
        vote8 = RewardVote(
            oracle_address=vote7.oracle_address,
            nonce=vote7.nonce,
            signature=vote7.signature,
            body=RewardVoteBody(
                update_timestamp=vote7.body.update_timestamp,
                root=vote7.body.root,
                ipfs_hash=vote7.body.ipfs_hash,
                avg_reward_per_second=vote7.body.avg_reward_per_second,
            ),
        )
